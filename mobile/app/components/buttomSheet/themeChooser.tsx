...
export default function ThemeChooser() {
	...
	return (
		<>
			<BottomSheetHeader headerText="App Appearance" />

			<BottomSheetSection
				headerText="Theme"
				BodyComponent={
					<BottomSheetCard className="flex-row h-52 items-center justify-evenly rounded-xl">
			...
			<BottomSheetSection
				...
				BodyComponent={
					<BottomSheetCard className="flex-row px-5 py-2 justify-between items-center rounded-xl">
						{
